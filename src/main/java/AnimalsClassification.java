...
public class AnimalsClassification {
    ...
    protected static int numExamples = 150;
    ...
    public void run(String[] args) throws Exception {
        ...
        File mainPath = new File("/home/austin/Documents/animals/");
        ...
        if (save) {
            log.info("Save model....");
            ModelSerializer.writeModel(network, "/home/austin/Documents/" + "model.zip", true);
        }
